...
const resources = {
  ru: {
    ...
    welcome: {
      ...
      intro_text2: 'Выполняйте задания на сайте parimatch.kz и в ваших любимых играх таких как Dota 2, зарабатывайте бонусные баллы и обменивайте их на скины и другие предметы в магазине.',
  ...
  kz: {
    main: {
      ...
      next: 'Ары қарай',
      attach: 'Қосу',
      product_filter: 'Товарлар фильтрі'
    },
    banner: {
    ...
    profile: {
      ...
      dota_history_closed: 'История матчей закрыта, проверьте настройки', // перевести
    ...
    welcome: {
      ...
      intro_text1: 'Это официальный продукт компании Париматч.', // перевести
      intro_text2: 'parimatch.kz сайтында және сіздің Dota 2 сияқты сүйікті ойындарыңызда тапсырмаларды орындаңыз, бонустық баллдарды жинаңыз және оларды дүкендегі скиндерге және басқа заттарға айырбастаңыз.',
