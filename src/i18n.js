...
const resources = {
  ru: {
    ...
    faq: {
      ...
      answer4_text2: 'Авторизуйтесь и перейдите на страницу;',
      answer4_text3: 'Нажмите на кнопку «Принять вызов», чтобы подтвердить участие;',
      answer4_text4: 'Выполняйте квесты каждый день и получайте гарантированные сундуки с призами и кристаллами;',
      answer4_text5: 'Собирайте кристаллы из сундуков и поднимайтесь в рейтинге игроков;',
      answer4_text6: 'Принимайте участие в еженедельных розыгрышах призов, включая ноутбук Lenovo Legion Pro 7, ASUS TUF Gaming, Iphone 14 Pro Max, PlayStation 5, Apple Watch 8, Airpods 3 поколения, бонусы на сумму 5 000 000 тенге еженедельно и FreeBet суммой до 100 000 тенге каждый;',
      answer4_text7: 'Собирайте кристаллы из сундуков и поднимайтесь в рейтинге игроков;',
      answer4_text8: 'Чем выше сумма ставки, тем выше рейтинг и круче призы.',
  ...
  kz: {
    ...
    faq: {
      ...
      answer4_text6: 'Lenovo Legion Pro 7, ASUS TUF Gaming, Iphone 14 Pro Max, PlayStation 5, Apple Watch 8, 3 буынның Airpods, апта сайынғы 5 000 000 теңге сомаға бонустар және әрқайсысы 100 000 теңгеге дейін сомаға FreeBet қосқанда, апта сайынғы жүлделер ұтыс ойындарына қатысыңыз;',
      answer4_text7: 'Сандықтардағы кристалдарды жинаңыз және ойыншылар рейтингісінде көтеріліңіз; ',
      answer4_text8: 'Тігілген ұтыстың сомасы неғұрлым көп болса, соғұрлым рейтингі жоғары және жүлделер жақсырақ болады.',
