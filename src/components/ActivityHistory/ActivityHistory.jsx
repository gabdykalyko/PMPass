...
const ActivityHistory = () => {
  ...
  const errors = {
    ...
    user_reached_limit_24h: `К сожалению ваш ежедневный лимит превышен. Перейдите к <a class="${styles.link}" href='/#question7'>FAQ</a> для получения информации о возможных проблемах с ежедневным лимитом.`,
